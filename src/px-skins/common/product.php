...
<?php elseif($product_info !== null): ?><?php px_include_template('productinfo', array('product' => $product_info, 'offset' => $offset, 'query' => $query, 'category_id' => $category_id, 'lid' => $lid, 'from_page' => $from_page, 'showbacklink' => true, 'sort' => $sort)); ?><?php else: ?>
